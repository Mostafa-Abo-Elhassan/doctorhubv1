...
{
    /// <inheritdoc />
    public partial class klflsdk : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthCenterId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthCenter_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoHAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoHAlerts_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHospitals = table.Column<int>(type: "int", nullable: false),
                    TotalLabs = table.Column<int>(type: "int", nullable: false),
                    ActiveAppointments = table.Column<int>(type: "int", nullable: false),
                    CompletedAppointments = table.Column<int>(type: "int", nullable: false),
                    PrescriptionsIssued = table.Column<int>(type: "int", nullable: false),
                    LabTestsRequested = table.Column<int>(type: "int", nullable: false),
                    LabTestsCompleted = table.Column<int>(type: "int", nullable: false),
                    VaccinationsScheduled = table.Column<int>(type: "int", nullable: false),
                    VaccinationsCompleted = table.Column<int>(type: "int", nullable: false),
                    EmergencyCasesToday = table.Column<int>(type: "int", nullable: false),
                    EarlyWarning = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoHReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoHReports_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmacyAdress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Children_HealthCenter_HealthCenterId",
                        column: x => x.HealthCenterId,
                        principalTable: "HealthCenter",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Children_Patients_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GrantedToUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GrantedToId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsentRecords_AspNetUsers_GrantedToId",
                        column: x => x.GrantedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Personals_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Personals_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VaccinationRecords_HealthCenter_HealthCenterId",
                        column: x => x.HealthCenterId,
                        principalTable: "HealthCenter",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LapName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabOrederId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileDocuments_LabOrders_LabOrederId",
                        column: x => x.LabOrederId,
                        principalTable: "LabOrders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FileDocuments_LabResults_LabResultId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicationAId = table.Column<int>(type: "int", maxLength: 200, nullable: false),
                    MedicationBId = table.Column<int>(type: "int", maxLength: 200, nullable: false),
                    Severity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicationInteractions_PrescriptionItems_MedicationAId",
                        column: x => x.MedicationAId,
                        principalTable: "PrescriptionItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MedicationInteractions_PrescriptionItems_MedicationBId",
                        column: x => x.MedicationBId,
                        principalTable: "PrescriptionItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "9E466E21-3B55-4F4D-8D99-123456789001", null, "Rider", "RIDER" },
                    { "9E466E21-3B55-4F4D-8D99-123456789002", null, "Driver", "DRIVER" },
                    { "9E466E21-3B55-4F4D-8D99-123456789003", null, "Company", "COMPANY" },
                    { "9E466E21-3B55-4F4D-8D99-123456789004", null, "Patient", "PATIENT" },
                    { "9E466E21-3B55-4F4D-8D99-123456789005", null, "Doctor", "DOCTOR" },
                    { "9E466E21-3B55-4F4D-8D99-123456789006", null, "Pharmacy", "PHARMACY" },
                    { "9E466E21-3B55-4F4D-8D99-123456789007", null, "Lab", "LAB" },
                    { "9E466E21-3B55-4F4D-8D99-123456789008", null, "Hospital", "HOSPITAL" },
                    { "9E466E21-3B55-4F4D-8D99-123456789009", null, "HealthCenter", "HEALTHCENTER" },
                    { "9E466E21-3B55-4F4D-8D99-123456789997", null, "MoHAdmin", "MOHADMIN" },
                    { "9E466E21-3B55-4F4D-8D99-123456789998", null, "SuperAdmin", "SUPERADMIN" },
                    { "9E466E21-3B55-4F4D-8D99-123456789999", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Children_HealthCenterId",
                table: "Children",
                column: "HealthCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsentRecords_GrantedToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileDocuments_LabOrederId",
                table: "FileDocuments",
                column: "LabOrederId");

            migrationBuilder.CreateIndex(
                name: "IX_FileDocuments_LabResultId",
                table: "FileDocuments",
                column: "LabResultId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthCenter_UserId",
                table: "HealthCenter",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationInteractions_MedicationAId",
                table: "MedicationInteractions",
                column: "MedicationAId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MedicationInteractions_MedicationBId",
                table: "MedicationInteractions",
                column: "MedicationBId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MoHAlerts_CreatedByUserId",
                table: "MoHAlerts",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MoHReports_CreatedByUserId",
                table: "MoHReports",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccinationRecords_HealthCenterId",
                table: "VaccinationRecords",
                column: "HealthCenterId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_HealthCenter_HealthCenterId",
                table: "AspNetUsers",
                column: "HealthCenterId",
                principalTable: "HealthCenter",
                principalColumn: "Id");
